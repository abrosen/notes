...
\section{Education}          
    \begin{itemize}    
    \item {\bf Ph.D.} in Computer Science, Georgia State University. Fall 2016 (Expected)
...
\begin{itemize}
	\item We designed and built a framework which maps distributed hash tables to the primitives of Voronoi Tesselation and Delaunay 
...
{\bf D$^3$DNS, 2013 }
    \begin{itemize}
    \item We created a prototype secure and fault-tolerant replacement for DNS.
...
{\bf Fields:} Distributed Hash Tables, Fault Tolerant Networks, Compilers, Simulations, Databases, Networking, TCP/IP, Data Mining,  HCI

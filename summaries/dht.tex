...
\textbf{Stretch} \cite{hildrum2004distributed} - The ratio of distance traveled by the lookup compared to the actual lookup distance.
\section{Pastry}
...
\section{Tapestry}
Tapestry \cite{tapestry} is based off the same prefix-based lookup as Pastry \cite{pastry}.
Tapestry views itself more as a DOLR \cite{dolr}.
\cite{hildrum2004distributed}

...
Large, centralized frameworks are the norm
these frame works require a noisy amount of overhead to setup to obtain $ O(1) $ lookup table.
...
remove data center assumptions set of assumptions \cite{hadoopAssumptions}

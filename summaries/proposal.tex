...
\begin{table}[h]
	...
	\begin{tabularx}{\textwidth}{ |X|X|X|X|X| }
		...
		Chord \cite{chord}, & $O(\log n)$, max $\log N + $ neighbors & $O(\log n)$, avg $\frac{1}{2} \log n)$  &  $<O(\log n^{2})$ with high probability   & This is where most DHTs fall  \\ \hline

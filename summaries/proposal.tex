...
The questions and goalss here are straight forward:
\begin{itemize}
	\item Further establish the phenomena exists.
	\item We stumbled across this phenomena with a brute force method and still got promising results.  Can we create a more balanced 

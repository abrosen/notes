...
This phenomena is described in detail in Chapter \ref{sec:auto-load-bal}, but .

%VHash as the ur-example
The second  \cite{vhash} \cite{dgvh}
...
\begin{itemize}
	\item Brendan and I implemented our own Distributed DNS system.
	\item Sybil paper.
\end{itemize}

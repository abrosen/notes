...
Distrtibuted Hash Tables are the backbone for many P2P systems.
...
\begin{itemize}
	\item P2P file sharing is by far the most prominent application of DHTs.  The most well-known application is BitTorrent \cite{bittorrent}, which is built on Mainline DHT \cite{mainline}.
	\item Distributed DNS.
	\item Distributed storage.
	\item Whatever Cassandra does

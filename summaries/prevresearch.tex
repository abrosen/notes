...
We calculated that it would take only 1221 IP addresses to compromise 50\% of the links in a 20,000,000 node network.

\subsection{Experiments}
The primary experiment of our project was simulating the complete eclipse a network using a Sybil attack, starting with a single malicious node.
We simulated a network of $n$ nodes.
Each node is represented by an ID generated by taking the SHA1 of a random IP/port combination.

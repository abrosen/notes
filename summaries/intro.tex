...
\begin{itemize}
	...
	\item Distributed Domain Name Systems (DNS) have been built upon DHTs \cite{cox2002serving} \cite{pappas2006comparative}.
	...
	\item Many botnets are built on
	\item Live video streaming (bittorrent live)
\end{itemize}
...
\begin{itemize}
	...
	\item My work could be 
\end{itemize}

Unlike the current distributed applications which utilize distributed hash tables, we want to create a complete framework

\subsubsection{General Challenges of Distributed Computing}
